...
(function (root) {
  ...
  var ACTIONS = [
    ...
    { id: 'videoNext', group: 'View', label: 'Next video on the page', hint: 'Switches to it, maximized if you are' },
    { id: 'videoPrev', group: 'View', label: 'Previous video on the page', hint: 'Back the other way' },
